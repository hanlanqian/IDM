...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet(ReadCss.readCss('./Mainwindow.css'))
        ...
        self.DownloadType.currentIndexChanged.connect(self.combobox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        ...
        self.checkBox_3.setGeometry(QtCore.QRect(40, 190, 121, 21))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_2.setStyleSheet("color:red;")
        self.checkBox_3.setText(_translate("MainWindow", "限速下载"))
        self.checkBox_3.setStyleSheet("color:red;")
